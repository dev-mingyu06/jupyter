 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "273e09c7-156e-4ecb-b23a-80b82a38d016",
   "metadata": {},
   "outputs": [],
   "source": [
    "import pandas as pd"
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 3,
   "id": "84b34f0f-eddb-44fc-8909-9e07b3156bc4",
   "metadata": {},
   "outputs": [
    {
     "data": {
   ...
   "source": [
    "df = pd.read_csv('../py_cmg/python_stat_sample-master/data/ch1_sport_test.csv',\n",
    "                 index_col='학생번호')\n",
    "df"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 4,
   "id": "b2b884b4-cb51-4a37-ad49-db3d27995987",
   "metadata": {},
   "outputs": [
    {
     "data": {
   ...
   "source": [
    ...
    "import pandas as pd\n",
    "\n",
    "df = pd.read_csv('../py_cmg/python_stat_sample-master/data/ch2_scores_em.csv', index_col='student number')\n",
    "df.head()\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 5,
   "id": "b090101c-1e7f-4e0e-914a-aebfc1e233c4",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 6,
   "id": "31e92181-6ae3-47d0-b6f5-8106f492c237",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 7,
   "id": "c2c311ce-db22-4091-96ae-acff8daab747",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 8,
   "id": "35fb2cfa-53fe-413b-853d-82b97a42dcf1",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 9,
   "id": "a1b9aca7-f260-4a71-bbb6-0877551052c7",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 10,
   "id": "ac84d51b-c10c-4a7e-a33b-86182b430a2a",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 11,
   "id": "350c97bd-f612-4d07-9724-047b5d3b00cb",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 12,
   "id": "f0fbad0a-8a9e-4812-93f6-2076ac764bca",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 13,
   "id": "dc31405d-d7c4-4dce-8ee2-42213afde47f",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 14,
   "id": "b2b62f80-ac7f-45f7-ad6a-9d0b64136313",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 15,
   "id": "9f060237-482b-42d5-ac80-f34a2a1e13a9",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 16,
   "id": "d34f3e96-f09e-4e94-835b-392c06d9d4cd",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 17,
   "id": "ea3206ac-8fcb-4fd9-b10c-30a3e1acd4fb",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 18,
   "id": "8bf9e69d-c311-4797-ace0-45297f92cab5",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 19,
   "id": "2fa70df0-8b2d-452a-9a79-feffe70d6549",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 20,
   "id": "140d61d1-9812-4130-890d-ccd7a608d731",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 21,
   "id": "0a87804e-1013-4245-8bfa-2bf7fa52c45a",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 22,
   "id": "6d16ff2d-ae6a-4e2b-a60e-0e3b3ec10ee2",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 23,
   "id": "e5d5ddd5-3229-44ca-b5bc-7ef97cde0698",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 24,
   "id": "48bd4f6b-e5ab-4e6c-bf8e-53bc7d99a65a",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 25,
   "id": "62738314-915e-49c8-b81f-5e15760831eb",
   "metadata": {},
   "outputs": [
    {
     "data": {
      "text/plain": [
       "np.float64(9.775252199076787)"
      ]
     },
     "execution_count": 25,
     "metadata": {},
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 26,
   "id": "2ac868d5-5625-454f-a0b3-af22bff4d157",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 27,
   "id": "b4991100-d788-4ee3-a177-61dc3afb75db",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 28,
   "id": "ada28eeb-a340-43e8-ab6f-3d31708ad7c3",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 29,
   "id": "57bedfa3-a463-4109-8545-cd29c228ad6c",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 30,
   "id": "bd1adbc1-06e8-48c8-8448-d50c8380a25a",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 31,
   "id": "ea1c0243-d4d1-4924-87de-e2a675d29e13",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 32,
   "id": "a4501f85-9710-4257-b6cc-0b501701c73a",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 33,
   "id": "532df712-c636-4073-96a2-dd67b80d491e",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 34,
   "id": "bfbbf169-0bf8-44e6-ae09-13a849e11752",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 35,
   "id": "15c440ff-1605-4450-a98c-6f4903ab6137",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 36,
   "id": "59ed2567-cd8b-46d0-93fb-339a83cd50a5",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 37,
   "id": "213cda26-935f-4f1e-90e9-cee227d8b7c2",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 38,
   "id": "f716aa71-f0de-4059-8759-c2f9d3bec3eb",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 39,
   "id": "f5356603-5c16-45f4-b77b-3609a91cbbe1",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 40,
   "id": "d4e69ed7-f6af-41d0-aac4-5ebc9876bbdb",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 41,
   "id": "653faf04-b0b8-41ab-ab25-e1b4fd9e68b8",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 42,
   "id": "4960b110-6e7a-4442-a95d-e2c59c9caaee",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 43,
   "id": "015d091d-a34a-4e94-92a6-0b275a1b83f9",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 44,
   "id": "4f465fb9-efaf-4362-941a-f16b9a5fc294",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 45,
   "id": "55dae84d-7ea7-4642-a100-58e8cf16320c",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 46,
   "id": "4323f0a3-dd1d-47de-a1f5-095183755d04",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 47,
   "id": "7cb5e2ee-0d30-4d9e-8634-4083e2e6ca7b",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 48,
   "id": "fba8713b-dc32-404c-bca3-4dc9dafc7465",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 52,
   "id": "ef15320a-9d85-44ad-a679-a8e89fae721c",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 55,
   "id": "cbd19016-d9c5-408d-abbf-c9da237774ba",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 56,
   "id": "2af1f68b-652f-43c7-9f34-663975ef076c",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 59,
   "id": "47209939-04d2-4539-a5d8-9e99cb381e1d",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   ...
   "id": "41630745-b4fb-4d25-921e-000e46010cf7",
   "metadata": {},
   "outputs": [],
   "source": []
  }
